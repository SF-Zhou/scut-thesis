...
参考文献举例说明：关于书的\cite{Meta_CN,goossens1994thelatex}，关于期刊的\cite{chen2007ewi}，会议论文\cite{DPMG}，硕士学位论文\cite{zhubajie}，博士学位论文\cite{shaheshang}，技术报告\cite{NPB2}，电子文献\cite{xetex_lyx,Texmaker}。
